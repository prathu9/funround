...
const SignUp = () => {
  ...
  const onSubmit = (data: SignUpInput) => {
    ...
    localStorage.setItem("user-detail", JSON.stringify({...data, isLoggedIn: true, termsOfUse: false}));
  ...
  return (
    ...
    <FormProvider {...methods}>
      ...
      <form onSubmit={methods.handleSubmit(onSubmit)} className="w-full h-full max-w-[696px] py-[47px] absolute top-[1.2vw] left-1/2 -translate-x-1/2 scale-90 rounded-2xl bg-black sm:h-fit sm:px-12 sm:border sm:border-white">
        ...
        <p className="py-6 text-lg text-[#8996A9]">
            By creating an account, you agree to the <button onClick={handleShowTerms} className="text-white">Terms of Use.</button> 
        </p>
