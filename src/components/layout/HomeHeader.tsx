...
const DesktopHeader = () => {
  ...
  return (
    ...
    <div className="hidden px-8 pt-[30px] w-full h-[86px]  justify-between items-end z-10 lg:absolute sm:flex xl:px-[120px]">
      ...
      {email && emailVerified ? (
        ...
        <div>
          ...
          <Link
            href="/signup"
            className="px-12 p-[25px] bg-[white] text-[#503CC6] rounded-full text-2xl font-bold duration-500 hover:bg-gray-400"
          >
            Login | Register
          </Link>
        </div>
