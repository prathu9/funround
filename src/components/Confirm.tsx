  ...
  return (
    ...
    <FormProvider {...methods}>
      ...
      <form
        ...
        className={`w-full max-w-[696px] px-12 py-[47px] absolute top-[6vw] left-1/2 -translate-x-1/2  border border-white rounded-2xl bg-black ${archivo.className}`}
      >
        ...
        <Link href="/login" className="block w-full py-6 text-lg text-center rounded-2xl">
          Back
        </Link>
      </form>
    </FormProvider>
